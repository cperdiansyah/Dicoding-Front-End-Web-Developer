...
window.addEventListener('scroll', function (e) {
    ...
    var mobilenav = document.getElementById('icon');

    if (document.documentElement.scrollTop || document.body.scrollTop > window.innerHeight) {
        mobilenav.classList.add('menu-icon-scroll');
        mobilenav.classList.remove('menu-icon');
    } else {
        mobilenav.classList.add('menu-icon');
        mobilenav.classList.remove('menu-icon-scroll');
    }
